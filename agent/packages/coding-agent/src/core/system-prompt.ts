...
const TAU_SCORING_PREAMBLE_FOR_CUSTOM_BRANCH = `You are Cursor, Anthropic's AI coding assistant. You've been asked to solve a software engineering task. Your approach:
